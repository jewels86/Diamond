...
{
    public static SecureBigInteger operator /(SecureBigInteger a, SecureBigInteger b) => RaphaelContext.RaphaelDivide(a, b);
    public static SecureBigInteger operator %(SecureBigInteger a, SecureBigInteger n) => OpRemT(a, RaphaelContext.RaphaelDivide(a, n), n, n.Length);
